...
iCtrlWizard.validFingerprint = function(ignoreOpenAlert) {
    ...
    if(!result && !ignoreOpenAlert) {
        ...
        elContent.innerHTML = '<div class="swal-text w-100 text-center m-0">Debe registrar minimo dos huellas del cliente.<br></div>';
        ...
        for (let item of valHFp) {
            if(''+item.tipo == '1') {
                ...
                rowsToAddHist.push({
                    ...
                    'modulo': ((''+item.tipo == '2')? 'Solicitud': 'Facturación')
                });
            }
        }
