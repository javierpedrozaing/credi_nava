...
iCtrlWizard.sendNewRequest = function(valData, fn) {
    ...
    if(valData.update == 'on') {
        dataToSend = {
            ...
            'rp3_parentesco':parseInt(valData.rp3_parentesco ||   $('select[name="uco_rp3_parentesco"]').val()) || '' ,
            ...
            'rp4_parentesco': parseInt(valData.rp4_parentesco ||  $('select[name="uco_rp4_parentesco"]').val()) || '',
    ...
    jQuery.ajax({
        ...
        success: function(data) {
            ...
            if(!data.error){
                ...
                console.log(data.RespuestaPersonalizadaMotor)
