<style type="text/css">
    ...
    #cedula .files-container #req-msg {
        color: #ea4641;
        font-weight: bold;
        font-size: 16px;
    }
...
.verde:focus {box-shadow: 0 0 5px rgba(0,255,0,1);border:1px solid rgba(0,255,0,0.8);} */
    ...
    #lblRc1Otro, #rc1Otro, #lblRc2Otro, #rc2Otro, #lblRc3Otro, #rc3Otro, #lblRc4Otro, #rc4Otro {
        display: none;
    }
                                    ...
                                    <div class="col-md-12" id="dircol">
                                        <div class="row">
                                            <div class="col-md-2">
                                                ...
                                                <?= $this->Form->select('uc_direccion', $direcciones, ['label' => 'Dirección: *', 'class' => 'c-field', 'required' => 'true']) ?>
                                            </div>
                    ...
                    <div id="updateClientOptional" style="display:none;">
                        ...
                        <form id="formSeerOptional" class="row mb-0 c-form-group" onsubmit="return false;">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-12" id="dircol">
                                        <div class="row">
                                            <div class="col-md-10 pr-0">
                                                <label>Dirección: *</label>
                                                <?= $this->Form->text('uco_full_address', ['id' => 'uco_full_address', 'class' => 'c-field', 'readonly' => 'readonly', 'required' => 'true']); ?>
                                            </div>
                                            <div class="col-md-2" style="padding-left: 0px;padding-top: 15px;margin-left: -1px;">
                                                <a href="javascript:iCtrlWizard.showAddressGenerator('uco_full_address');" class="btn" style="width: 100%;font-size: 15px;">DIRECCIÓN</a>
                                            </div>
                                            <!--<div class="col-md-2">
                                                <label>Dirección: *</label>
                                                <?php //echo $this->Form->select('uco_direccion', $direcciones, ['label' => 'Dirección: *', 'class' => 'c-field']) ?>
                                            </div>
                                            <div class="col-md-1" style="padding-left: 0px;">
                                                <label> </label>
                                                <?php //echo $this->Form->text('uco_di1_cli', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)']) ?>
                                            </div>
                                            <div class="col-md-1" style="padding-left: 0px;">
                                                <label>#</label>
                                                <?php //echo $this->Form->text('uco_di2_cli', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)']) ?>
                                            </div>
                                            <div class="col-md-1" style="padding-left: 0px;">
                                                <label>-</label>
                                                <?php //echo $this->Form->text('uco_di3_cli', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)']) ?>
                                            </div>

                                            <div class="col-md-2" style="padding-left: 0px;">
                                                <label>Tipo Vivienda</label>
                                                <?php //echo $this->Form->select('uco_cod_residencia', [], ['label' => 'Unidad:', 'class' => 'c-field empty']) ?>
                                            </div>

                                            <div class="col-md-3" style="padding-left: 0px;">
                                                <label>Nombre(Unidad,Conjunto,Edificio)</label>
                                                <?php //echo $this->Form->text('uco_unidad', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)']) ?>
                                            </div>

                                            <div class="col-md-2" style="padding-left: 0px;">
                                                <label># Apto ó Casa</label>
                                                <?php //echo $this->Form->text('uco_di4_cli', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)']) ?>
                                            </div>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row b-bottom pl-16 pr-16 cont-ref-lab" style="padding-bottom: 4px;">
                                ...
                                <div class="row cont-ref-lab">
                                    <div class="col-md-12">
                                        <label>Empresa:*</label>
                                        <?= $this->Form->text('uco_rl1_nom_emp', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)']) ?>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="files-container p-5 containercc">
                                    <div class="row">
                                        <div class="col col-md-12" id='cedulaIntegra'>
                                            ...
                                            <a class='btn btn-danger  text-white mt-5' onClick='iCtrlWizard.removeCC()' style='display:none' id='removeCC'><i class="fa fa-window-close"></i> Eliminar</a>
                                        </div>
                            ...
                            <div class="tab-content" style="padding-top: 0px;">
                                ...
                                <div class="tab-pane active show" id="perfil">
                                    <div id='viewDataCredito' >
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                <p style="text-align: center;font-size: 16px;color: #f44335;">Los campos con * es obligatorio diligenciarlos</p>
                                            </div>
                                        </div>
                                        <div class='row mt-3'>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" id="dircol">
                                            <div class="row">
                                                <div class="col-md-10 pr-0">
                                                    <label>Dirección: *</label>
                                                    <?= $this->Form->text('full_address', ['id' => 'full_address', 'class' => 'c-field', 'readonly' => 'readonly', 'required' => 'true']); ?>
                                                </div>
                                                <div class="col-md-2" style="padding-left: 0px;padding-top: 15px;margin-left: -1px;">
                                                    <a href="javascript:iCtrlWizard.showAddressGenerator('full_address');" class="btn" style="width: 100%;font-size: 15px;">DIRECCIÓN</a>
                                                </div>
                                                <!--<div class="col-md-2">
                                                    <label>Dirección: *</label>
                                                    <?php //echo $this->Form->select('direccion', $direcciones, ['label' => 'Dirección: *', 'class' => 'c-field', 'required' => 'true']) ?>
                                                </div>
                                                <div class="col-md-1" style="padding-left: 0px;">
                                                    <label> </label>
                                                    <?php //echo $this->Form->text('di1_cli', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)', 'required' => 'true']) ?>
                                                </div>
                                                <div class="col-md-1" style="padding-left: 0px;">
                                                    <label>#</label>
                                                    <?php //echo $this->Form->text('di2_cli', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)', 'required' => 'true']) ?>
                                                </div>
                                                <div class="col-md-1" style="padding-left: 0px;">
                                                    <label>-</label>
                                                    <?php //echo $this->Form->text('di3_cli', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)']) ?>
                                                </div>

                                                <div class="col-md-2" style="padding-left: 0px;">
                                                    <label>Tipo Vivienda</label>
                                                    <?php //echo $this->Form->select('cod_residencia', [], ['label' => 'Unidad:', 'class' => 'c-field empty']) ?>
                                                </div>

                                                <div class="col-md-3" style="padding-left: 0px;">
                                                    <label>Nombre(Unidad,Conjunto,Edificio)</label>
                                                    <?php //echo $this->Form->text('unidad', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)']) ?>
                                                </div>

                                                <div class="col-md-2" style="padding-left: 0px:">
                                                    <label># Apto ó Casa</label>
                                                    <?php //echo $this->Form->text('di4_cli', ['class' => 'c-field', 'onkeyup' => 'onlyUpperCase(this)']) ?>
                                                </div>-->
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="ref-comerciales">
                                    ...
                                    <div class="row" id="rc1">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label id="lblRc1Otro">Nombre del almacén:</label>
                                            <?= $this->Form->text('rc1_otro', ['id' => 'rc1Otro', 'class' => 'c-field rc_otro', 'onkeyup' => 'onlyUpperCase(this)']); ?>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row" id="rc2">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label id="lblRc2Otro">Nombre del almacén:</label>
                                            <?= $this->Form->text('rc2_otro', ['id' => 'rc2Otro', 'class' => 'c-field rc_otro', 'onkeyup' => 'onlyUpperCase(this)']); ?>
                                        </div>
                                        <div class="col-md-6">
                                            <label>Estado de Cuenta:</label>
                                    ...
                                    <div class="row" id="rc3" style="display:none;">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label id="lblRc3Otro">Nombre del almacén:</label>
                                            <?= $this->Form->text('rc3_otro', ['id' => 'rc3Otro', 'class' => 'c-field rc_otro', 'onkeyup' => 'onlyUpperCase(this)']); ?>
                                        </div>
                                        <div class="col-md-6">
                                            <label>Estado de Cuenta:</label>
                                    ...
                                    <div class="row" id="rc4" style="display:none;">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label id="lblRc4Otro">Nombre del almacén:</label>
                                            <?= $this->Form->text('rc4_otro', ['id' => 'rc4Otro', 'class' => 'c-field rc_otro', 'onkeyup' => 'onlyUpperCase(this)']); ?>
                                        </div>
                                        <div class="col-md-6">
                                            <label>Estado de Cuenta:</label>
                                ...
                                <div class="tab-pane" id="huella">
                                    ...
                                    <div class="row row-questions text-left">
                                        ...
                                        <div class="col col-md-6 text-center">
                                            ...
                                            <div class="col-12 text-center">
                                                <button type="button" id='btn-hands' name="button" class="btn btn-cancel btn-fill btn-danger" onclick="iCtrlWizard.registerFingerprints()">
                                                    Registrar huella(s)
                                                </button>
                                            </div>
                                            ...
                                            <div class="files-container pt-16">
                                                <div class="row">
                                                    <div class="col col-md-12">
                                                        ...
                                                        <span id="req-msg">* Es obligatorio ingresar la cédula</span>
                                                    </div>
                                                    <div class="col col-md-6">
                                                        <div class="">&nbsp;</div>
                                                        <div class="preview-file">
                                ...
                                <div class="tab-pane" id="resultado">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <?= $this->Form->text('res_val_dis', ['class' => 'c-field', 'disabled' => 'disabled', 'style' => 'background-color: #ffffd0 !important;color: #f44336 !important;']) ?>
                                        </div>
                                        <div class="col-md-4">
                                            <label>Saldo:</label>
...
<script>
    ...
    ctrlDataWizard.direcciones = <?= json_encode($direcciones) ?>;
